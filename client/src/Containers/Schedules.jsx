...
*</b>
  ...
  <br></br>
    <br></br>
    <p className="KGN">*Schedule is subject to change due to holidays and school breaks. Always check our calendar prior to coming for open play.*
    </p>
    <p className="KGN">*Reservations are required for all sessions. Book your spot by phone or online.*
    </p>
    <p className="KGN">*Walk-ins permitted based on availabity!*
    </p>
