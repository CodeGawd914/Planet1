...
class Attractions extends Component {
  ...
  render() {
    return (
      ...
      <p className='KGN'>Calling all toddlernauts! Our toddler section is a secure gated in area that is sure to make your toddler smile. With a variety of soft blocks, wall games, magnet boards, and more, we have created a safe place for our youngest cadets to practice the art of play and socialization!
      </p>
