...
also fostering an undeniable love for reading.</b></p>
  ...
  <Table.Body className='smooth12'>
    <Table.Row>
      <Table.Cell textAlign='center'><p>Cosmic Kids</p> <p className="KGN"><b>10:15-11</b></p></Table.Cell>
      <Table.Cell textAlign='center'><p>Blast Into Learning</p> <p className="KGN"><b>10:15-11</b></p></Table.Cell>
      <Table.Cell textAlign='center'><p>Storytime & Connection</p> <p className="KGN"><b>10:15-11</b></p></Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell textAlign='center'><p>Messy Play</p> <p className="KGN"><b>1-1:45</b></p></Table.Cell>
      <Table.Cell textAlign='center'><p>Special Needs Art & Play</p> <p className="KGN"><b>1-1:45</b></p></Table.Cell>
      <Table.Cell textAlign='center'><p>Blast Into Learning</p> <p className="KGN"><b>1-1:45</b></p></Table.Cell>
    </Table.Row>
  </Table.Body>
  </Table>
        </Grid.Column>
